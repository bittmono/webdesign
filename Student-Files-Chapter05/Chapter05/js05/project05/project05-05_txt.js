...
//in for loop, changed <= to <
//changed board.insert to board.insertBefore
...
//changed This to this in lastElementChild
//changed if (tilesFlipped = 1) -> if (tilesFlipped === 1)
//changed else if (tilesFlipped = 2) -> else if (tilesFlipped === 2) 
//changed timeID = window.setTimeout(flipBack, 1) to (flipBack, 1000);
//titlesFlipped -> tilesFlipped
//changed firstFlipped and secondFlipped from This to this
//this.lastElementChild.className = "back" -> this.lastElementChild.className === "back"
