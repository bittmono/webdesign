...
var billBox = document.getElementById("bill");
...
function runTheRegister() {
   ...
   try {
      ...
      calcChange(changeValue); // determine the units of currency needed for change
   } catch (error) {
...
function calcChange(changeValue) {
   ...
   // Determine the number of $5 bills - changed to 5, originally was 3
