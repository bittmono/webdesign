/*    JavaScript 7th Edition
      ...
      note: i couldnt figure out what i was doing wrong, so this project doesnt work
*/
...
// Adds stars for rating, loops x amt based on rating
...
// Creates table that shows review from each customer
for (let i = 0; i < reviewers.length; i++) {
      ...
      reviewCode += "<caption>";
      reviewCode += reviewTitles[i];
      reviewCode += "</caption>";
      reviewCode += "<tr>";
      reviewCode += "<th>By</th>";
      reviewCode += "<td>"; 
      reviewCode += reviewers[i] 
      reviewCode += "</td>"
      reviewCode += "</tr>"; 
      reviewCode += "<tr>";
      reviewCode += "<th>Review Date</th>";
      reviewCode += "<td>"; 
      reviewCode += reviewDates[i]; 
      reviewCode += "</td>";
      reviewCode += "</tr>";
      reviewCode += "<tr>";
      reviewCode += "<td colspan='2'>";
      reviewCode += reviews[i]; 
      reviewCode += "</td>";
      reviewCode += "</tr>";
...
if (articles.length > 0) {
    ...
    firstArticle.insertAdjacentHTML('beforeclose', reviewCode);
}